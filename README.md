...
PIPELINE-GNN-5HT1A/
├── docs/
│   ├── Project/              # Documento del proyecto en LaTeX
│   │   ├── build/
│   │   ├── figures/
│   │   ├── sections/
│   │   ├── main.tex
...
- Documento técnico completo en LaTeX: `docs/Project/main.tex` (compilado en `docs/Project/build/main.pdf`).
- Bitácora de avances y decisiones: `docs/bitacora_00.md`.
- Bibliografía gestionada en Zotero, exportada automáticamente a `docs/Project/referencias.bib`.
